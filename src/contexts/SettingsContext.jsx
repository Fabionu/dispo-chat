...
export const THEMES = {
  ...
  midnight: {
    ...
    '--c-surface2': '#131830',
    '--c-surface3': '#1a203e',
    '--c-border':   'rgba(140,160,255,0.06)',
    '--c-border-md':'rgba(140,160,255,0.10)',
    '--c-border-lg':'rgba(140,160,255,0.15)',
    '--c-msg-own':  '#1e2545',
    '--c-msg-other':'#121730',
    light: false,
    label: 'Midnight',
  ...
  dusk: {
    ...
    '--c-surface2': '#1e1830',
    '--c-surface3': '#261f3e',
    '--c-border':   'rgba(200,160,255,0.07)',
    '--c-border-md':'rgba(200,160,255,0.11)',
    '--c-border-lg':'rgba(200,160,255,0.16)',
    '--c-msg-own':  '#231838',
    '--c-msg-other':'#160f28',
    light: false,
    label: 'Dusk',
  ...
  forest: {
    ...
    '--c-surface2': '#152019',
    '--c-surface3': '#1c2a20',
    '--c-border':   'rgba(120,220,140,0.06)',
    '--c-border-md':'rgba(120,220,140,0.09)',
    '--c-border-lg':'rgba(120,220,140,0.13)',
    '--c-msg-own':  '#162419',
    '--c-msg-other':'#0e1810',
    light: false,
    label: 'Forest',
