...
export default function ProfilePanel({ user, onLogout, onClose }) {
  ...
  return (
    <>
      ...
      <div
        className="absolute bottom-16 left-2 right-2 z-50 rounded-2xl overflow-hidden shadow-xl shadow-black/60"
      ...
      >
        ...
        <div className="px-5 pt-5 pb-4">
          <div className="flex items-center gap-3 mb-5">
            <div
              className="w-10 h-10 rounded-full flex items-center justify-center text-sm font-medium text-white/60 flex-shrink-0 overflow-hidden"
          ...
          <div className="space-y-1.5">
            <p className="text-[10px] text-white/25 tracking-widest uppercase font-semibold">Your code</p>
            <button
              onClick={copyCode}
            ...
            <p className="text-[11px] text-white/20 leading-relaxed px-0.5">
        ...
        {/* Sign out */}
        <div className="px-2 py-2" style={{ borderTop: '1px solid var(--c-border)' }}>
          <button
            onClick={onLogout}
